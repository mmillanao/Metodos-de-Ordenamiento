...
#### Autores: Muriel Millanao y Monserrat Vergara.
### Como ejecutar
...
```
Finalmente, el algoritmo recorre el vector ordenado y muestra la lista de estudiantes con sus respectivas notas, organizada de manera descendente.  
```cpp
    int n = estudiantes.size();
